...
class Palette {
  ...
  Color get ink => const Color(0xeefdff00);
  Color get backgroundMain => const Color(0xff002309);
  ...
  Color get mtYellow => const Color(0xffffb800);
  Color get mtGreen1 => const Color(0xff002309);
}
